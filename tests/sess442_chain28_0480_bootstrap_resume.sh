#!/bin/bash
# sess442 chain 28: build 0.48.0 (item 5d fixes from the design-consult code review +
...
cd /src/mxfs || exit 1
LABEL=${1:-s442a}
LOG=tests/evidence/sess442_chain28_0480_bootstrap_resume_$LABEL.log
EV=tests/evidence/sess442_chain28_0480_bootstrap_resume_$LABEL
mkdir -p "$EV"
{
  echo "=== sess442 chain28 start $(date -u +%FT%TZ) ==="
