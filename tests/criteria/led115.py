...
for e in ents:
    if e.get('id')=='D-SAMENODE-WAITER-CANCEL-COLLISION':
        e['next_step']=("sess115 design-consult RULING (supersedes the sess114 plan): the cached-lock code fact was ACCEPTED and blockers 2 and 3 are WITHDRAWN. "
          ...
          "Evidence: docs/history/cached-lock-model-invalidates-blockers-2-3.md and ...sess115-GPT-ruling-blockers-2-3-WITHDRAWN-two-new. "
