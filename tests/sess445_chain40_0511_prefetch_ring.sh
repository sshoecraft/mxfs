#!/bin/bash
# sess445 chain 40 (0.53.0, built by chain 39): D-0511 second measurement —
...
cd /src/mxfs || exit 1
while ! grep -q "^DONE" tests/evidence/sess445_chain39_0512_Aprime_s445b.log 2>/dev/null; do sleep 30; done
LABEL=${1:-s445c}
LOG=tests/evidence/sess445_chain40_0511_prefetch_ring_$LABEL.log
{
