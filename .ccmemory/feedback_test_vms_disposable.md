...
**Why:** They're disposable test infrastructure for kernel module work. Confirmed 2026-04-25 in v0.3.4 session — got a stuck D-state on test2 from v0.3.3 self-deadlock and asked permission to virsh destroy. User (paraphrased): do whatever you need to with the test VMs; they don't matter.
