...
Full reply of record: **/src/mxfs/DLM_PLAN_REVIEW.md** (committed alongside the plan). Input = both docs verbatim + the 15-item errata from `docs/net2-plan-of-record.md`.
...
## Staged plan (each stage the derived-budget rule gated)
