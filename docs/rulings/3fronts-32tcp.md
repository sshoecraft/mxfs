<!-- GPT ruling (the design-consult rule) on the 3 32/tcp fronts: B=ioend grant-epoch drain state machine (ship first), C=gen-qualified orphan intent, A=master BAST-at-ins… -->
