<!-- sess66: design-consult ruling on moving recovery_begin() to fence time — dedicated coordinator, not the HB thread; PLUS the proof that recovery_pending[] is… -->
...
## The ruling (the design-consult rule, gpt-5.6-sol) — binding points
