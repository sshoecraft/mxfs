<!-- GPT the design-consult rule design for the dir-block torn-write fix: tenure-authorized write fence + per-tenure publish registry + supersession certificates + reader… -->
...
- v1 (sess6, landed): at the P-DIRWR chokepoint — sub-EX && !drain-task:
  ...
  Defect A stays OPEN per the zero-defect bar until v2.
