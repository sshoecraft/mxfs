<!-- sess47(ccloop) GPT-5.5 architectural design for the reused-dir LEAF-vs-data durable tear: release-side force-complete ALL dir-fork buffers (incl leaf… -->
...
### NEXT (the instrument-first loop): VERIFY whether mxfs_dir_flush_data_blocks_relsafe / flush_one_daddr
