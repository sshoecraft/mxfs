<!-- sess35 GPT-5.5 consult + fix: round-1 dir_reuse loss = epoch starts 0 → disables stale-base evict during fresh-dir growth → stale freeindex/bestfree… -->
...
### GPT-5.5 root (design consult, converges with evidence)
...
See `docs/history/compiled-dir-reuse-newtenure-evict-bli-retire-round1-format.md`.
</body>
