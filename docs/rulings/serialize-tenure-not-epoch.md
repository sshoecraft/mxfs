<!-- sess10 GPT-5.5 VERDICT: root=double-grant via lossy heartbeat; fix=strict dir-EX tenure serialization + reload-on-reacquire + MHT batching, NOT a CAW… -->
## GPT-5.5 consult (escalation after Gemini x2 same issue). DECISIVE. For `docs/history/docs/history/docs/history/compiled-tcp-dlm-scaling-sess10-doublegrant-tenure.md`.
