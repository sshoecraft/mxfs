<!-- sess45 GPT-5.5 consult (RULE-5): KEY insight — raw SCSI FUA at release makes the PLATTER current but leaves XFS buffer DIRTY/in-AIL, so addname_coher… -->
...
`docs/history/winning-config-and-remaining-work.md` `docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md`.
