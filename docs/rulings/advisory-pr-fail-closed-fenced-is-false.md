<!-- sess69 GPT ruling: on advisory PR there is NO safe automatic recovery — fail closed. The FENCED stage is a FALSE claim today, and this hits INITIAL v… -->
...
`docs/history/docs/history/docs/history/compiled-scsi-pr-fence-evidence-campaign.md` — the call
