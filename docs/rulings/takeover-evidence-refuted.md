<!-- sess68 GPT ruling: my takeover predicate REFUTED (sector non-residency is not fencing); slot_live is indexed by SLOT not incarnation (real bug); 4 mo… -->
...
This session asked GPT (the design-consult rule) to rule on the three points the sess66
