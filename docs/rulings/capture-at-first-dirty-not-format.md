<!-- sess102 design-consult ruling: format-time authority lookup is UNSOUND (stamps a later epoch than authorized the mutation). Capture at first protected dirty.… -->
# sess102 design-consult ruling — step 5.3 capture point
...
Collector: `tests/ownauth_counters.sh <n> [snapshot]` (the source-tree rule, new this
