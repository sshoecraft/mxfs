<!-- sess305: P283 root PROVEN (concurrent dup release pipelines alias shared rel_state) + design-consult ruling: per-instance tenure-bound proof cert, cas_noproo… -->
# sess305 — P283-RELCERT-CAS-UNPROVED root + GPT ruling

## Root (PROVEN BY INSTRUMENT from existing fleet dmesg, no build needed)
