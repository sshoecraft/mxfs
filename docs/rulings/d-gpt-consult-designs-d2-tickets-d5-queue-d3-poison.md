<!-- sess14 GPT consult (the design-consult rule): D2 = deadline visibility-tickets design; D5 = queue-reload+serve-stale-once; D3 fences → permanent write-poison + tenure… -->
