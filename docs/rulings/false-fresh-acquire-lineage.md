<!-- GPT consult (sess3 8ba7ae5c): dbl-alloc root ranked = FALSE-FRESH acquire discards CIL-resident AG-meta (H-A>H-B). Probe design: grant-lineage cert +… -->
# GPT-5.6 consult (the design-consult rule, 2026-07-16, sess3 ccloop 8ba7ae5c) — AG double-alloc mechanism ranking

Input evidence: `docs/history/docs/history/docs/history/compiled-ccloop8ba7-dblalloc-caw-ladder.md` (6 uv-dir blocks re-handed
