<!-- sess6 ROOT PROVEN: dir_reuse@32/caw wedge#2a = lost b_iowait wakeup. owner_scan sync bwrite completes but routes to XBF_ASYNC branch (relse/queue_wor… -->
