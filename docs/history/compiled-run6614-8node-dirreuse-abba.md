<!-- run6614 ccloop sess6-7: 8-node dir_reuse ABBA drain_evict deadlock, leaked i_lock(rm), reused-dir EIO shutdown, refuted barrier levers. -->
...
- **9AA569A0** — gg_refresh=1 + dir_release_flush_leaf=1 (both KEEP, proven). 1/2/4 tcp=100%,
  8/tcp ~16/17 (~1/3 fail). The best default; baseline for sess6 work. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **97E09EE8** — adds behavior-neutral P6-DIRPATH / P6-DIRPHANTOM atomic counters + `dirphantom_dump` param. Measurement build. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **414432A9** — GPT-5.5 "must-complete invalidation barrier" (log_force+drain_evict-until-left==0). REFUTED (1/5), reverted. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **900BB963** — sess6 HEAD, UNTESTED at relay boundary: candidate-A (arm gg_refresh on hgg==0 && !self_created). Later REFUTED in sess7. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **D7A9A25E** — pristine N=8 baseline re-measured in sess7; HANGS at 8. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **638E582919B7D49E** — drain_evict ABBA fix (blocking down_read → bounded trylock). KEEP; cut mass-loss 700→797/800. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
- **F5A90E91C5841F8B** — sess7 END HEAD = pristine baseline behavior + behavior-neutral leak-attribution instrumentation only; ALL sess7 workarounds REVERTED. (== 9AA569A0-equivalent minus instr.) `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
`docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
(!self_created) multinode dirs, scoped to preserve the derived-budget rule solo-rsync perf.
`docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
B = release-durability gap. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
undetected handoff → stale-base RMW. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
`docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md` `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
unlock paths. Hypotheses to test (the instrument-first loop): (1) rm SIGKILLed mid-xfs_remove during an FS
...
lock; fix the leak, not the drain. `docs/history/docs/history/docs/history/compiled-run6614-8node-dirreuse-abba.md`
...
**NEXT (the instrument-first loop):** (1) pin FACE 1 via new P132 attribution → fix the leaking down_write path;
