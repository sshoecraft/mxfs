<!-- sess4/run6614: force_block tension = committed-undestaged dir-block0 evicted (not bnobt); config settled force_block=0, 2/tcp 17/17. -->
...
- `force_block=1` (tree DEFAULT, sess67, `xfs/xfs_mxfs_dlm.c:6607`): dir_reuse reliable
  ...
  2/tcp. See `docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`.
...
1. **3A16A85A (KEY, early)** — bare defaults (`force_block=1` + 4 dir levers=1:
   ...
   `docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`. **This was
...
2. **75F2759C (MILESTONE/ROOT)** — full `dir_force_block=0 run.sh 2 tcp` = **17/17
   ...
   `docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`
   `docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`
...
4. **6C7545D5 (REFUTE double-alloc for the garbage face)** — P-DBLALLOC-BIRTH: FUA
   ...
   `docs/history/docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`
...
5. P-DIRSTALE (gated undest||in_ail + dir magic) did NOT fire for block0 → at stale time
   ...
   violation (Invariant 1). `docs/history/docs/history/docs/history/compiled-dirreuse-run6614-sess4-forceblock-tension-bnobt-doublealloc.md`

### GPT-5.5 consult (the design-consult rule) — architectural fix
...
- Tooling in tree (the source-tree rule): `scripts/ccloop_reset.sh <N>`, `scripts/drc_reliability.sh <N> <RUNS> [modargs]`.
