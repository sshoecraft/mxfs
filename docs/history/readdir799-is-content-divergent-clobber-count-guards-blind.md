<!-- sess22(ccloop) KEY: dir_reuse readdir=799 durable loss is a CONTENT-divergent clobber (under-EX stale-base RMW replaces a peer's entry, count stays e… -->
...
### dir_reuse residual is ONLY this face now (leaf-hash lookup_fail HEALED by sess22 datascan). See `docs/history/docs/history/compiled-readdir799-diagnosis-datascan-heal-remove-reorder.md` `docs/history/fix-node-format-datascan-leafhash-heal.md` `docs/history/docs/history/compiled-readdir799-diagnosis-datascan-heal-remove-reorder.md`.
