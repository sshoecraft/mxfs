<!-- Compiled: rename/create visibility is a publish-side bug — deferred-publish gap, divergent-base mkdir, reg-file reuse-adopt, chokepoint arch. -->
...
lost-update. Sources: `docs/history/session-39-lessons.md` (initial root-characterization,
2026-05-30) → `docs/history/docs/history/compiled-cc-create-rename-publish-visibility.md` → `docs/history/docs/history/compiled-cc-create-rename-publish-visibility.md` → `docs/history/session-106-lessons.md` →
`docs/history/session-107-lessons.md` → `docs/history/docs/history/compiled-cc-create-rename-publish-visibility.md` (all 2026-06-06, ccloop run
...
(`docs/history/docs/history/compiled-cc-create-rename-publish-visibility.md` reframe). The harness (`run_tests.sh:258`) has ONE node
...
cluster-wide and its later `mv` ENOENTs (`docs/history/session-106-lessons.md` decisive evidence:
...
### Root cause — the deferred-publish design gap (FULLY PROVEN, `docs/history/session-107-lessons.md`)
...
This is the same "in-memory EX without on-disk slot" state `docs/history/session-106-lessons.md`
...
same-dir rename (`docs/history/session-39-lessons.md`). Landed and KEPT:
...
(the design-consult rule): jiffies-bound (~1s) in-memory lease so only ~1 cheap slot read/sec/
...
make tools`). Two load-bearing changes (`docs/history/docs/history/compiled-cc-create-rename-publish-visibility.md`):
...
**Chokepoint (Phase 1.3 proper, Gemini codebase-aware design, the design-consult rule, KEEP):**
