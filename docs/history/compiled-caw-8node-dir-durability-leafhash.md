<!-- RESOLVED 8/caw dir_reuse_coherency: ungated P6L leaf scan (591A76FB) fixes leaf-hash drops; per-op CAW durable publish is load-bearing. -->
...
`docs/history/docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`, `docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`,
`docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`.
...
## the instrument-first loop diagnosis chain (sess6, `docs/history/docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`)
...
## RESOLUTION (2026-07-06, `docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`)
...
(`docs/history/docs/history/compiled-caw-8node-dir-durability-leafhash.md`) Hypothesis: per-op barriers
...
- dir_reuse budget is transport-aware in run.sh: **caw 140*N** (2→280, 4→560, 8→1120), tcp
  100*N. the instrument-first loop-proven structural floor (steady 40s/round × 24 ≈ 1000s; create 9-16s, verify
  ...
  to the instrument-first loop, not more budget.
...
counters as canaries — their text has no DPAT keyword; verify empirically first per the instrument-first loop):
