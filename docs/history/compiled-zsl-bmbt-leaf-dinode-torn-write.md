<!-- Compiled zero_silent_loss investigation (sess59-73): on-disk di_nextents runs ahead of bmbt leaf; writer torn release of hot shared dir ino=131. -->
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md`: **concurrent-EX REFUTED** — P58
...
cached bmbt CHILD blocks. **Result silent 1600→105.** `docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md`
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (probe build 503B10EC): the
...
time. Two the instrument-first loop disproofs: (1) **reader-FUA REFUTED** — `mxfs_fua_disable=1` by default
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (**8E495999, KEEP**): the
...
`docs/history/zsl-bmbt-leaf-write-essentially-never-submitted.md` (**3221AE35**): the
...
`docs/history/zsl-root-di-ahead-of-bmbt-leaf-ordering.md` (build BA1771B9): PROVEN the on-disk
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (B548E404): evicting the cached
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (**663F1716**, SUPERSEDES the
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (**E277C0DA**): raw `dd`
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (**E6A40C95, KEEP** — proven
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (probe build B9C27147): Face-2
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (build 16520C7B; P65-LEAF-FABRICATE
...
sub-2×-native likely needs lock-stickiness/leasing (the derived-budget rule slowness is a separate FAIL).

### sess66 — write-side clobber proven; tenure-authority write gate built
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (**88688A48, BUILT, NOT TESTED**).
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (build 88688A48 tested, then
...
/ -SKIP probes (NOT yet observed under storm). **NOTE: host wedged at session end (the never-reboot-clyde rule,
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md` (build **64932978** =
...
- **The tension the arc never resolved:** different runs show BOTH "disk is correct, reader
  ...
  on this single-shared-dir workload is a SEPARATE the derived-budget rule FAIL (P138-WAIT 6.4s EX handoffs,
