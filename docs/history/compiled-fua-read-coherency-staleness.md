<!-- Compiled: SCST FUA-reads-stale-platter root, fua_disable=1 default, inode-cluster over-logged clobber guard, atime-on-read EX clobber. -->
# FUA-read staleness & clobber roots (cache_coherency criterion)

Compiled from `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`, `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`, `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`,
`docs/history/docs/history/compiled-fua-read-coherency-staleness.md`. All four converge on ONE architectural fact and its
...
fully coherent — `docs/history/docs/history/compiled-fua-read-coherency-staleness.md` `tests/dur_probe.sh`).

## The FUA-stale-platter root and the fix arc (chronological)

- **`docs/history/docs/history/compiled-fua-read-coherency-staleness.md` (2026-06-02, build `3D36F352`→`5ED458EB`, head `F6C9DAAC`).**
...
- **`docs/history/docs/history/compiled-fua-read-coherency-staleness.md` (2026-06-05, build `7DF27971`).** GPT consult (RULE-5)
...
- **`docs/history/docs/history/compiled-fua-read-coherency-staleness.md` (2026-06-05, build `354813F9` = fua default only;
  ...
  `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`/sess43 said was needed (FUA-reread dir-coherency was
...
### 1. Inode-cluster FUA over-logged clobber — FIXED `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`
...
### 2. Stuck `XFS_ISTALE_CAW` → d_revalidate thrash → 120s barrier timeouts `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`
...
### 3. dialloc EFSCORRUPTED — FUA-independent, dominant surviving shutdown `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`
...
## The atime-on-read EX clobber (di_size=0) — separate WRITE-side root `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`
...
## Residuals under 4-node concurrency `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`
...
- **The unifying architectural root** (`docs/history/docs/history/compiled-fua-read-coherency-staleness.md` honest re-assessment):
...
- **DEADLOCK LEARNING `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`:** in-place inode reload during
...
- **bnobt double-free is a REAL durable lost-update, not a red herring**
  (`docs/history/docs/history/compiled-fua-read-coherency-staleness.md` P81-DEXT: `disk_claims_freed=1 disk_differs=0` = DISK-INODE-
  ...
  (worse), P91 FUA-write-through (no change) — all `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`.
- **Strategic pivot `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`:** stop chasing individual VISIBILITY races
