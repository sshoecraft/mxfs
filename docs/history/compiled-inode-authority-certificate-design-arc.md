<!-- Compiled: inode authority certificate sess95-101 — rulings (cert not cache, CAS out-param, release-begin chokepoint), landings 0.11.428-435, measurem… -->
...
said. Continues `docs/history/docs/history/compiled-foreign-replay-authority-tokens.md` (steps 1-3); the release-side
wiring that follows this arc is sess104/sess162/sess163.

## Design rulings (each rejection names the load-bearing hazard)

**sess95 — both initial designs REJECTED** `docs/rulings/step5-3-inode-authority.md`:
...
`docs/history/docs/history/docs/history/compiled-inode-authority-certificate-design-arc.md`.

**sess96 — grant_meta hash-cache epoch source REJECTED** `docs/rulings/step5-3-producer-rejects-cache.md`:
...
0.11.429 `docs/history/docs/history/docs/history/compiled-inode-authority-certificate-design-arc.md`.
...
- **0.11.431** the authority state machine: `i_mxfs_auth_state`
  ...
  BEFORE begin_release wiring `docs/history/docs/history/docs/history/compiled-inode-authority-certificate-design-arc.md`.
...
`docs/history/docs/history/docs/history/compiled-inode-authority-certificate-design-arc.md`: rsync_paired PASS 32/32
...
`docs/rulings/ag-cert-rejected-plus-ownauth-instrument.md`: broad
