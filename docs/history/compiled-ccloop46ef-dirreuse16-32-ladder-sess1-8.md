<!-- Compiled ccloop46ef sess1-8: chase of 16/32-node CAW dir_reuse/cache_coherency ladder — roots found/fixed, 16/caw complete, sess8 regression open. -->
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`:
...
`docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. This tenure-floor/grace design is the
...
power-cycling run `docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`.
...
- **Torn-publish clobber** (real, but crash-dependent — later shown non-general): a node
  ...
  *same daddr*, overwriting the crashed node's block content
  `docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Real bug (crash-recovery
...
- **Victim-node EIO family** (the actual per-run driver): 1-3 nodes/run go mount-wide EIO
  ...
  (sg_persist keys all present) `docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`.
  ...
  `docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Also fixed this session:
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Three hygiene fixes
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Also found: a CAW-path hole
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. **This PLATTER-TORN verdict
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Remaining failure at
...
leaf" — result landed the session's END `docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`: **samelun=1 every
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. **This memory-clobber theory is
...
1. **broot-bytes stale-field oops → node wedge → cluster starvation** (v0.10.31, build
   ...
   node, not corruption**
   `docs/history/root-broot-bytes-oops-and-wedge-chain.md`. Fix A: zero
...
2. **bmbt release-fence blind spot → stranded leaf → manufactured CRC storm** (v0.10.32,
   ...
   *dirty in-core* image against a CRC only ever stamped at write time, manufacturing
   ...
   `docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Fix D (root): drop the
...
3. **Stale `b_iowait` completion token → perpetual CRC on one node** (v0.10.33, build
   ...
   `docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Fix: `reinit_completion` on the
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Re-running the 32-node trio on
...
`docs/history/docs/history/docs/history/compiled-ccloop46ef-dirreuse16-32-ladder-sess1-8.md`. Build `v0.10.33`
