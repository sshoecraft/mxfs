<!-- Sess30 (2026-05-07) — Path A (manual-bio CAW submission) shipped v0.3.128. Partial fix at small scale; residual at 15× scale. caw_verify retry compounds with caller retries — DO NOT USE. -->
