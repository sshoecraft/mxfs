<!-- sess64 compiled: node1_f1 loss = dir logical-block0 double-allocation (block-format, not shortform); fix = epoch-gated disk-block adopt. -->
...
### Fix path (`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-doublealloc-block0-root.md`)
