<!-- sess2(3e02e7dd): wedge#2a lost-wakeup FIXED+PROVEN (full 24rd 32/caw run, 0 hangs). NEW: r18 readdir undercount (exp=3200 got=3199, ALL 32 nodes). -->
...
(see `docs/rulings/dir-reuse-32-architectural-review.md`): fixing one layer's bug
