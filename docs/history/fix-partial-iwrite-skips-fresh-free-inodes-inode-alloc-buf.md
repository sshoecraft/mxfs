<!-- sess45 PROVEN FIX (build C0554679/EF006296): mxfs_submit_partial_inode_write skipped freshly-init'd FREE inodes (di_mode=0, ordered-buf, unlogged) →… -->
...
(`docs/history/docs/history/docs/history/compiled-sess44-45-data-over-inode-cluster-double-alloc-wedge.md`) — watch in the full suite.
...
P45-WB disk-read-per-writeback REMOVED. `docs/history/proven-data-over-inode-doublealloc-clobber-payload-visible.md`</body>
