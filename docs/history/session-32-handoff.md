<!-- sess32 HEAD: dir_reuse loss is WITHIN-tenure (held EX at destage); RMW base always fresh (POSTRMW=0); leading hypothesis = duplicate/ghost xfs_buf pe… -->
...
### PROVEN this session (the instrument-first loop + GPT-5.5 ×2)
...
### NEXT SESSION (the instrument-first loop)
