<!-- sess28-29 dir_reuse 8/tcp: EX-holder destages stale in-AIL bgen0 base; write-side 3-way merge refuted, dir_release_invalidate+relinval_clean win ~85% -->
...
An early sess28 `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`
...
shut=3000+ SHUTDOWN cascade). See `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`.
...
`docs/history/decisive-loss-is-writeside-read-coherent-diff0-p28c0.md`. `diff1=0` over 300
...
`held_mode=5 (EX) in_ail=1 dirty=0 bgen=0` `docs/history/smokinggun-exholder-destages-stale-inail-base-bgen0-mergeneeded.md`.
...
- `dir_subset_guard=1` (suppress any write where disk has an inumber in-core lacks):
  CATASTROPHIC **readdir=316/800** `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`.
...
not a drop `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`.
...
(behaviorally == prior keeper 164A6D5D) `docs/history/handoff-head-build-c1b4bfc0-next-step-3way-merge.md`.
...
`docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`. At the chokepoint it FUA-reads the
...
the over-count `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`:
...
`docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`:
...
Two levers deliver it `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`:
...
1 FAIL ≈ 85%** `docs/history/corrected-state-dir-reuse-85pct-not-100-flush-lockwait-harmful.md`.
