<!-- CAW deploy conditions: 3+1 condition script inventory, dm-multipath CAW+PR verified, caw-mpath ladder 1-8 PASS, infra fixes. -->
...
### The deployment conditions (user framing, 2026-07-05) `docs/history/docs/history/caw-test-3-conditions-and-script-inventory.md`
...
4. **CAW over dm-multipath** — SAN (FC or iSCSI) with ≥2 paths + multipathd, mounting
   `/dev/mapper/mpathX`. `docs/history/docs/history/compiled-caw-multipath-deploy-conditions.md`

### Script inventory (all in `scripts/`, the source-tree rule) `docs/history/docs/history/caw-test-3-conditions-and-script-inventory.md` `docs/history/docs/history/compiled-caw-multipath-deploy-conditions.md`
...
### Infra verified at 32 nodes, all 3 base conditions, 2026-07-05 (infra-only, EXIT 0) `docs/history/docs/history/compiled-caw-multipath-deploy-conditions.md`
...
Verifier bugs found + fixed (the instrument-first loop): (1) direct login raced iscsid at boot → session with
...
### Condition 4 — CAW over dm-multipath: BUILT + VERIFIED 2026-07-05 `docs/history/docs/history/compiled-caw-multipath-deploy-conditions.md`
...
**sess6 (ccloop 186320ae)** `docs/history/docs/history/caw-multipath-matrix-progress.md`: 2/caw formation failure was
...
**ccloop 5bea4199 (build 591A76FB)** `docs/history/docs/history/docs/history/compiled-caw-multipath-deploy-conditions.md`: ladder
...
NOT break 8/caw — the instrument-first loop: only strip if 16/32 shows a timing/log-volume/dump_stack FAIL with
...
dir_reuse timeout can't poison fence/fault/soak (run104 cascade). Watch the derived-budget rule timing at
