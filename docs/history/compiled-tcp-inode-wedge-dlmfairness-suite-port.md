<!-- TCP-DLM port arc: non-CAW slot fix→dlm_fairness PASS, 8 tests ported to 13/16, deep stale-inode double-free wedge fixed by B4 no-authority guard. -->
...
## Fix 1 — non-CAW slot claim (root of dlm_fairness FAIL) `docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
## Fix 2 — strict inode-AG partition `docs/history/docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
## 8 PENDING tests ported `docs/history/docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
## 13/16 milestone and its 3 FAILs `docs/history/docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
### Residual double-alloc via AG spillover `docs/history/docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
### FAST REPRO (build AFC07F4D) `docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
...
### Fix 3 — B4 "no-authority" inactivation guard (build B4168BB5) `docs/history/docs/history/compiled-tcp-inode-wedge-dlmfairness-suite-port.md`
