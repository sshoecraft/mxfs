<!-- sess3(a16ec5f2) ROOT PROVEN+FIXED: P22-SFTORN-SKIP via flush_out CONSUMED ili_fields w/o writing → committed dir contraction lost → map-of-freed-bloc… -->
...
Links: `docs/history/end-dinode-regression-root-run12-odsync-pace-fixed.md`
