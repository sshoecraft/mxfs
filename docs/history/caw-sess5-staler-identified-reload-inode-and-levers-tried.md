<!-- sess5 REFINED: the 32-node inode-cluster staler = mxfs_dlm_reload_inode (xfs_mxfs_dlm.c:14417) on reused-inode grant + bast_process. MHT-up HURTS. Fi… -->
...
See `docs/history/docs/history/caw-sess5-32node-fresh-baselines-and-fua-read-root.md` `docs/history/caw-32node-dlm-scaling-fix-progress-and-fable-design.md`.
