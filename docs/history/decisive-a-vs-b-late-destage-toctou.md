<!-- sess32 CONFIRMED on losing iter: P-POSTRMW stale-base=0 on all 8 nodes while P-WMERGE fires 3-6x. RMW base always fresh; block goes stale post-releas… -->
...
### Probe build 6056E587 (dir_postrmw_probe default-off, keeper-safe). Cluster: reboot to clear. CRITERIA NOT MET. `docs/history/session-32-handoff.md` `docs/history/decisive-a-vs-b-late-destage-toctou.md`
</body>
