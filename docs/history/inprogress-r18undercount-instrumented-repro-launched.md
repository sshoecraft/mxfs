<!-- sess2 continuation: instrumented (instr=1 dirwr=1, NFILES=10 ROUNDS=40) 32/caw repro LAUNCHED to catch the round-18 single-dirent-loss with full data… -->
## Where this picks up from `docs/history/wedge2a-fixed-full24round-clean-new-r18-undercount.md`
...
Search `docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md` (sess65, 8 source memories) —
...
`docs/history/criterion-met-2tcp-17of17-8consecutive.md` (a DIFFERENT, separate criterion,
