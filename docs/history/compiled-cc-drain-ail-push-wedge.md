<!-- Compiled: release/acquire-side drain-pipeline + AG-AIL-push wedges (leaked cluster-buf locks, torn forks) hanging cache_coherency at shutdown. -->
...
GFS2 reference contract (`docs/history/docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`)
...
See `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
...
in-AIL-safe evict there if a visibility residual shows. See `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
...
blocked-task stacks, the instrument-first loop): `mxfs_dlm_bast_process` honored Invariant #1 with a
...
reads it). See `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
...
(this is what sess112/113 chase). See `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
Handoff `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`: `413C9D5D` deployed all 4, cc_run4 IN PROGRESS and
...
`docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
...
b_lock_ip probe. See `docs/history/docs/history/compiled-cc-drain-ail-push-wedge.md`.
