<!-- Compiled TCP 2-node posix_multi stall thread: theory arc from dir lost-update→ifree-drain→lost DLM grant msg; -ETIMEDOUT retry fix → 8 PASS. -->
## Central topic
...
`docs/history/docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: `./run.sh 2 tcp posix_multi` — both
...
`docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: convergence is VOLUME-dependent. 10 files/node →
...
`docs/history/docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: instrumented phase timing
...
`docs/history/docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: tests/repro_burst_timed.sh (per-create
...
`docs/history/docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: supersedes the ifree-drain theory for the
...
`docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: 3 small edits (KEEP):
...
`docs/history/docs/history/compiled-tcp-2node-posix-multi-lost-dlm-grant.md`: the one -ETIMEDOUT retry fix fixed the ENTIRE
...
## Carry-forward follow-up (the derived-budget rule — the retry MASKS, doesn't cure)
...
## Tooling & env (all in tests/, persistent per the source-tree rule)
