<!-- Compiled: TCP-DLM dir-EX double-grant heisenbug + gen-token fix, cc dir-evict in-AIL discriminator, residual stale-readdir root. -->
...
- **73B0809D5381454A7F9B070** — B4 inode guard + P-RDDIAG (mxfs_instr-gated). 15/16;
  `tcp_dlm_scaling` ~50% flaky (F,F,P,P,F,F). `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
- **F053F523...** — B4 broadened to `!=EX`. 15/16; sole fail `tcp_dlm_scaling` stale-readdir
  (nlink=0 leftover). `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
- **98EC6332DCE76B24C5E1038** — B4 + THREE dormant diagnostic gates (mxfs.instr/dirwr/lockwr, all
  OFF; behaviorally == 73B0809D). Double-grant PROVEN. `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
- **30D3C28E** — B4 + dormant traces, 15/16. Canonical pre-fix fallback.
  `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md` `docs/history/docs/history/sess-tcp-double-grant-mechanism-refinement.md`
- **1ED7A5FD7AA0DD081826A62** — cc dir-evict in-AIL discriminator (KEEP). 15/16.
  `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
- **404BC55CA1AF4A73317C3DA** — BOTH landed fixes (cc dir-evict + DLM gen-token). Achieved multiple
  clean 16/16 back-to-back. Best build. `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
  `docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
that exposes the race. `docs/history/docs/history/sess-tcp-double-grant-mechanism-refinement.md`
...
in-band recording at the DLM lock sites shifts timing enough to close it. the instrument-first loop's "instrumented
...
CAW's `mxfs_v5_dlm_inode_ex_count`). `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
`docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md` `docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
Grant-generation protocol; re-affirm not remove+promote. `docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
(was reliable FAIL). `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
release; Architectural Invariant 1). `docs/history/docs/history/docs/history/compiled-tcp-dlm-doublegrant-gentoken-fix.md`
...
dirs are hit constantly by rsync_paired; the derived-budget rule barrier-desync). INSTRUMENT FIRST (the instrument-first loop):
...
must blindly reload). Gemini verdict (the design-consult rule): release MUST make committed dir state durable to
