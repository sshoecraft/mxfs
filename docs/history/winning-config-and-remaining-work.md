<!-- sess45 WINNING 8/tcp config: dir_release_fua_write=1 + dir_addname_coherent=1 + memb_settle_ms=20000 → 3/5 PASS (0 MASS), up from 0/5. Residuals: dir… -->
...
See `docs/history/breakthrough-8node-loss-is-intrablock-doublealloc-addname-coherent-fix.md`
`docs/history/resurrected-platter-lag-fix-dir-release-fua-write-default-on.md`
