<!-- sess5 END (build 1120BA0E): ABBA fully stack-proven — dir-grow btalloc blocks on peer AG w/ dirty trans+dir EX. Design: bounded/rotating AG acquire i… -->
# sess5 END — state @ build `1120BA0E3B136DE568FE01D` (deployed, in-tree)

READ FIRST: `docs/history/docs/history/docs/history/compiled-a16ec5f2-8node-dirent-loss.md` (fixes 1-3 + probe map + env cadence).
