<!-- sess22(ccloop) FIX build 42A12E6B: reorder xfs_dir_remove_child non-dir path so xfs_dir_removename runs FIRST (clean trans) — eliminates the 8/tcp di… -->
...
### Root of the 8/tcp dir_reuse 0/8 CASCADE (PROVEN, the instrument-first loop):
