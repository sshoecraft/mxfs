<!-- ccloop 186320ae caw-mpath matrix: sess6 infra fixes (superset teardown, hard converge gate, iscsi enable) → 2/caw green, 8/caw sweeping; build 57773C… -->
...
## Build chain
- `656E89B4` (v0.6.5, sess5): FIVE fixes → 4/caw 17/17 + 1/caw 17/17 (see docs/history/docs/history/caw-v065-fix-chain-4caw-17of17.md).
