<!-- sess61 DECISIVE: dir_reuse loss = DIRTY block0 buffer with bufgen=0 (stale tenure < i_dlm_dir_gen) materialized on a stale base, kept by the dirty-pr… -->
...
`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`,
`docs/history/docs/history/compiled-sess42-43-dir-reuse-sf-block-double-conversion-forceblock-fix.md`.</body>
