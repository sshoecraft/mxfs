<!-- Compiled: 32-node dlm_scaling root (shared AG-0 reread / CAW epoch inode-reuse handoff) + the dealloc epoch-invalidate fix design. -->
...
### Eviction is the lever, but eviction-scoping ALONE can't pass — `docs/history/caw-32node-dlm-scaling-fix-progress-and-fable-design.md`
...
### ROOT CAUSE, code-confirmed — `docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
...
`docs/history/docs/history/docs/history/compiled-host-wedge-clyde-scst.md`).

### The epoch is INTRA-RUN, not cross-mkfs — `docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
Corrects an earlier claim (`docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md`)
...
**REJECTED — gen in `resource_id.offset`** — `docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
...
**The constraint that kills the hash approach** — `docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
...
`docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
...
**AUTHORITATIVE consolidation** — `docs/history/docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md`
...
- **PR-wedge**: after ~20 power-cycles the cluster PR-wedged (reservation conflict on test2/3/4, all
  reads empty, `files present exp=120 got=0`) — the `docs/history/docs/history/compiled-caw-32node-dlm-scaling-epoch.md` fence, NOT a
