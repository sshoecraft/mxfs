<!-- sess36-38 dir_reuse endgame: platter-lag target-flush PASS, grant-evict/ail-defer combos, decisive gen-blind in-AIL clean-subset reflush clobber. -->
...
- `64544CAD` — keeper + `dir_grant_evict=1` (default ON) + `dir_conv_genbump=0`. See
  `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md` `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`.
- `CF57F8AB` — keeper-equiv; grant_evict + dir_conv_genbump BOTH default 0. Safe, no
  regression. sess36 disk head. `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md` `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`.
- `C949F3C3` — sess37 instrumentation build (P28-PLATTER compare; master_self field).
  `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md` `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`.
- `24946150` — sess37 dataclobber=1 detect-only ground-truth build. `docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`.
- `DFAEAF39` — sess37 disk head, keeper-equiv at default; all sess37 levers default 0.
  `docs/history/session-37-handoff.md`.

### sess36: grant-evict fix, then the platter-lag breakthrough
`dir_grant_evict` (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`) wires grant_gen into the
...
Result (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`): grant-evict is
...
BREAKTHROUGH (`docs/history/docs/history/compiled-dirreuse-sess44-46-epoch-unreliable-platterlag-isolation.md`): `dir_modify_target_flush=1`
...
sess36 proven diagnosis via dataclobber=1 + grant_evict capture (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`):
...
grant_evict + `dir_ail_defer` combo (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`):
...
sess37 re-instrumented (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`): P28-
...
BLI-retirement code facts (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`):
...
(NOTE: this DIRECTLY contradicts the docs/history/session-37-handoff.md "NEXT = delwri-submit" proposal,
...
master_self measurement (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`):
...
Fresh ground-truth split (`docs/history/compiled-dir-reuse-platter-lag-grantevict-inail-clean-reflush.md`, build
...
Residual face with best read-side stack ON (`docs/history/residual-is-equal-count-content-divergence-xfsaild-leaf.md`,
