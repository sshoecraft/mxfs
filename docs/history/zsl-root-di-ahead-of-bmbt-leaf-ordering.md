<!-- sess61 PROVEN: zsl root = dinode di_nextents=N reaches shared disk BEFORE matching bmbt leaf (N-1); reloader trips ir.loaded!=if_nextents. 2 fix hyps… -->
## sess61 (ccloop 14d31183) — zero_silent_loss root proven; 2 hypotheses refuted

Builds on `docs/history/zsl-bmbt-leaf-write-essentially-never-submitted.md` and
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md`. Criterion STILL FAILS
...
### REFUTED this session (the instrument-first loop — do NOT retry)
