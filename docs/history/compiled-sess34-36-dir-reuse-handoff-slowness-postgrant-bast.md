<!-- sess34-36: dir_reuse_coherency 2/tcp — 6s dir handoff root=missing post-grant BAST on ACQUIRING defer; fixed via prompt-BAST honor+MHT batching+mht30… -->
...
(300s TEST_TIMEOUT budget; ~16s/round × 24 ≈ 390s = the derived-budget rule FAIL) and **(2) CORRECTNESS** (drc-FAIL=0).
...
`docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md` (ccloop 8ddb16a2). Builds: baseline DBD3A375
...
PROVEN slowness chain `docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md`: the ~6s stalls
...
GPT-5.5 architectural plan `docs/history/docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md` (implement
INCREMENTALLY per the instrument-first loop). SLOWNESS items: (1) make "revoke pending" ORTHOGONAL to ISTATE_ACQUIRING —
...
`docs/history/docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md` (traces on build 24144BB4). The
...
Result `docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md`: fix WORKS — P35-ACQBAST-HONOR fired 11×
...
MHT-batching addition `docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md` (build **68B7C405** = A970F10B + GPT item
...
`docs/history/docs/history/compiled-sess34-36-dir-reuse-handoff-slowness-postgrant-bast.md`. Timing root = dir-EX lock THRASHING (~20 handoffs/round;
...
- **the instrument-first loop discipline:** MHT=0 (sess34) was tested and refuted; MHT=300 (sess36) was the fix — the lever
