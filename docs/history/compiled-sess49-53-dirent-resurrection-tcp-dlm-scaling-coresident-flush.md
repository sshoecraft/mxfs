<!-- sess49-53: cache_coherency P43 fix, dir-EX upgrade livelock, durable dirent resurrection via stale SF flush + merge-union; criterion NOT met (4/5). -->
...
misfire**, not storage (`docs/history/root-cache-coherency-uv-is-p43-fmtrevert-guard-misfire.md`).
...
The sess49 residual was then fully traced (`docs/history/residual-tcp-doublegrant-dir-resurrection-complete-diagnosis.md`):
...
FIX B (KEEP) killed the resurrection at its real source (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`):
...
PROVEN via 5+ min of live thrash dmesg (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`):
...
- **BROAD skip** (FFC0DA1D): `tcp_dlm_scaling` 4/4 PASS (EDEADLK hundreds→1-2, drain
  ...
  on BLOCK/LEAF dirs (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`).
- **SELF-demote-only** (build D50912EB): `dir_reuse`/`rsync` SOLID; `tcp_dlm_scaling`
  ...
  read+cleared at bast_process entry) (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`).
...
`mxfs_dir_drain_evict_data_blocks` (~3605) (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`,
`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`). FIXES the livelock (EDEADLK
...
BREAKTHROUGH (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`): the criterion
...
shutdown=0). BUT (`docs/history/docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`)
...
`drop_caches`. GPT-5.5 consult (the design-consult rule) gave the invariant, and two fixes landed (KEEP, in
86DDB26D / 21C36EEA) (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`):
...
The multi-node mechanism (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`,
`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`): node2 does
...
proof (`docs/history/docs/history/compiled-sess49-53-dirent-resurrection-tcp-dlm-scaling-coresident-flush.md`, build 21C36EEA):
