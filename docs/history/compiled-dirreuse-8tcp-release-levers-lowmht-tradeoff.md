<!-- sess19 ccloop: dir_release_invalidate lever cuts low-mht dir_reuse loss 18→2; mht tradeoff blocks 8/tcp suite; reload must stay handoff-gated. -->
...
`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-release-levers-lowmht-tradeoff.md`: first full `./run.sh 8 tcp` = **13 PASS / 4 FAIL** (build `0A6350A1`, mht=275 default).
...
The tradeoff, confirmed (`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-release-levers-lowmht-tradeoff.md`):
...
`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-release-levers-lowmht-tradeoff.md`: A/B at mht=50, build `15447D0C`, the instrument-first loop:
...
`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-release-levers-lowmht-tradeoff.md`:
...
### Speed problem (the derived-budget rule, first-class)
