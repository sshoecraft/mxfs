<!-- Compiled: c7ee71c6 sess40-48 (0.11.331-394) — AGI per-slot buckets, open-tracking/deferred reap, the 512B slot regression, version gate, P195 closure… -->
...
shutdown (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
(`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`):
...
(`docs/rulings/gpt-openunlink-audit-ruling.md`,
`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
(`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`). The ICLUSTER port later reached
matrix 9/9 at both knob settings (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
got attributed (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
and **aging out is not closure** (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
- **D-UNMOUNT-RELEASE-FLUSH-AFTER-PR-UNREGISTER**: `xfs_shutdown_devices()` ends with an
  ...
  `bt_bdev` is still valid) (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
- **D-DIRENT-PUBLISH-STALE-BASE-P195** — closed with GPT's Option B (adopt-at-EX-acquire,
  ...
  and got 0 (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
- **D-CACHE-COHERENCY-UV-COUNT-MISS — DISPROVED**, by an accident: three deliberate attempts to
  ...
  one degraded member (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
- **D-REAP-IFREE-EFSCORRUPTED-372** — root proven by a 40s deterministic repro: zombies parked
  ...
  **the fix must key off the bucket**, which survives
  (`docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`, `docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`,
  `docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`, `docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
earlier the same day (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`,
`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
- **The guard clock bug.** The recovery GUARD's staleness test compared `mxfs_pal_time_ms()`
  ...
  and not applied to its own kernel code (`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
- A B-side EIO was hunted across 5 faithful replays and **not reproduced**; two theories
  ...
  (`docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
...
noise on a zero-margin row (`docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`,
`docs/history/docs/history/docs/history/compiled-c7ee71c6-sess40-48-open-unlink-and-agi-era.md`).
