<!-- sess67 ccloop: dir_force_block=1 makes dir_reuse_coherency PASS 1/2 tcp; 4/8-node ROOT = xfs_dir3_data_init zeroes a live dir block via stale extent… -->
