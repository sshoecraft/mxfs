<!-- sess28(ccloop) SMOKING GUN: dir_reuse loss = the dir EX-HOLDER destages a stale in-AIL block (held_mode=EX, in_ail=1, dirty=0, bgen=0) carrying its o… -->
...
### Keeper C1B4BFC0 (all levers off). See `docs/history/handoff-head-build-c1b4bfc0-next-step-3way-merge.md` `docs/history/decisive-loss-is-writeside-read-coherent-diff0-p28c0.md` `docs/history/gpt-fix-design-freeslot-doublealloc-readdir799.md` [[sess101...]].
