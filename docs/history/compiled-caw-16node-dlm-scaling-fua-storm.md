<!-- 16-node caw dlm_scaling rate-floor fail = private-dir FUA storm; fixed (valid_epoch-gated dir_priv_ex_skip, build 8B203AA4) → 15/16. -->
...
XFS µs. PASSES at 1/2/4/8; fails at 16. See `docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md`.
...
See `docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md` (v1) and
`docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md` (v2). For a provably-private dir
...
(c) clear slot table at cluster-format/mount. See `docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md`
and `docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md`.
