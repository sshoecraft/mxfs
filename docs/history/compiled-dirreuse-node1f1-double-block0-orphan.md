<!-- sess65 compiled: node1_f1 loss in dir_reuse_coherency = dir block0 extent-map split + content clobber; fix = durable canonical-block0 DLM record. -->
...
### Central diagnosis: TWO coupled bugs, both proven byte-level (the instrument-first loop)
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md` and
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`. The
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`
...
Churn detail from `docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md` (build
...
From `docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`
...
- **P65-IFLUSH-FENCE / dir_iflush_fence** (iflush: skip flush when incore_b0 >
  ...
  perf hit (the derived-budget rule).
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md` initially
claimed dir_epoch_adopt=1 fully cured Stage 1 (all 4 nodes ext0→daddr120).
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md` retracts this: the
...
`docs/history/replay-timing-gap-adopt-at-coldread-not-create.md` (build 0676923D, on
...
### GPT-5.5 fix design (option a+c) — from `docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`,
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`, and
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`: the dir inode
...
`docs/history/docs/history/docs/history/compiled-dirreuse-node1f1-double-block0-orphan.md`: P64-N1F1 firehose
