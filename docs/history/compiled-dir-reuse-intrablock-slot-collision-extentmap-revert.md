<!-- sess27 dir_reuse 8/tcp blocker: proven intra-block dir-slot collision + dir extent-map/size revert; read path coherent, loss is write-side. -->
...
**(1) Intra-block dir-slot COLLISION** `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`.
...
`docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`.
...
- **force_coherent=1 — REFUTED, and DECISIVE**
  `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`: forcing every dir-block
...
- **The FINAL "read-staleness, targeted-reread is the fix" claim — REFUTED**
  `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md` argued from ONE
...
- **The epoch/cache-hit-staleness model — REFUTED**
  `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`: built
...
- **DEFINITIVE proof — the platter itself reverts**
  `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`: build
...
eviction / timing knobs don't touch it `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`.

## The design tension: durability ordering, not "re-read more"

`docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`: naive
...
**Concrete coverage gap** `docs/history/compiled-dir-reuse-intrablock-slot-collision-extentmap-revert.md`:
...
## Next-session plan (the instrument-first loop: catch the reverting WRITE)
