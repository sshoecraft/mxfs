<!-- Compiled run14d zero_silent_loss saga: torn BTREE dinode/bmbt, dir eviction-fence btree bail, relflush stale-write, LSN destage, probe-gating. -->
...
`docs/history/docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md` first fixed the **cache_coherency**
...
`docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: once ino 131 is BTREE, **all three dir
...
`docs/history/docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: `6AB6018C` drops losses 261→~80-109 and
...
`docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md` (`91BB755E`, built not run). **P34B refuted
...
`docs/history/docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: losses 84/iter → ~1 durable loss per
...
Two memories. `docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: recovered from the 2026-06-12
**manual host reset** (the never-reboot-clyde rule territory — user-only host recovery). Key discovery: the
...
`docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: the full-sweep build `4450524B` **FAILED** zsl
(iter2 silent=1 `node11_dir84` created-then-lost = the sess15 silent-1 class; then iter1
catastrophic EUCLEAN storm, `corrupt dinode 131 (btree extents)`). Hypothesis (the instrument-first loop
...
`docs/history/docs/history/docs/history/compiled-zsl-run14d-torn-dinode-dir-fence.md`: on a fresh
...
trylock-skip.** Not patched (the instrument-first loop: unreproducible on clean state; release-path changes
...
- **Never widen the zsl timeout** (the derived-budget rule): slowness correlates with the storm mode. 1-iter
...
- **Release-path changes have repeatedly regressed** — treat with the instrument-first loop discipline;
