<!-- sess22(ccloop) NEW gating shutdown: AGI block 0x2 CRC error in xfs_agi_read_verify during xfs_inactive_ifree (rm-rf inode free). Block content VALID… -->
