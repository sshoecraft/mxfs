<!-- sess14-15 crash_consistency root: block-dir concurrent-create durable dirent loss = reused-inode/daddr ABA; incarn-stamp fired 0x; 3-way SF merge fix… -->
...
- **Write-side SHORTFORM resurrection** (dlm_fairness `drained got=1`,
  ...
  `docs/history/docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`. FIXED by the
...
- **crash_consistency = BLOCK/LEAF-format dir**: 2 nodes each write 50
  ...
  `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`
  `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`
...
`docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md` → **3017D9DF**
...
still 3/6. `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md` Why safe vs sess9 refutations: keeps OUR
...
2×2 probe matrix `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`
`docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md` `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`:
...
writer wins. `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`

### sess15 fix attempt — buffer-incarnation stamp (IMPLEMENTED, fired 0×)
Design `docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`: the discriminator should
...
### Why incarn_aba=0 — next hypotheses (sess15 handoff, the instrument-first loop)
...
`docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`
`docs/history/docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`:
...
`docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`: relax P9 clean-gate /
...
### GPT-5.5 consult direction (the design-consult rule)
`docs/history/docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`
`docs/history/docs/history/compiled-blockdir-concurrent-create-sess14-15-3way-merge.md`: per-EPOCH (not per-op) authoritative reload on cross-node
...
### Assets / harnesses (in-tree, KEEP — the source-tree rule)
