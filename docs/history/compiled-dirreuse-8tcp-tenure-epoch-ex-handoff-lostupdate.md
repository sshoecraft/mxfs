<!-- sess16 ccloop: dir_reuse 8/tcp loss = mid-transaction dir-EX-handoff lost-update; tenure-epoch fix design + refuted acquire-side levers. -->
...
`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` is the
...
`docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: the lost names
...
block. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: the
...
- `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: force_coherent
  + postread both fail → not a cache-hit stale read.
- `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: build
...
- `docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: FUA write to
  platter bypassing the LIO write-back cache — same loss → not a LIO
  write/read cache gap.
- `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`:
...
- `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: two
...
- `docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: that overlap is an
...
- `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: DECISIVE.
...
`docs/history/docs/history/sess16run-acquire-side-refresh-cannot-work-must-be-release-side.md` (build
...
`docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` — the convergent
...
1. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` (build
...
2. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md`: the
...
3. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` (build
...
4. `docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` (build
...
5. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` (build
...
6. `docs/history/docs/history/docs/history/compiled-dirreuse-8tcp-tenure-epoch-ex-handoff-lostupdate.md` (build
