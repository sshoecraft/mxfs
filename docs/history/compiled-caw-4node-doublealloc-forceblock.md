<!-- Compiled: 4/caw cache_coherency FAIL = cross-node bnobt/dir-block double-alloc at agbno9; RESOLVED by dir_force_block=0, validated 2/4/8/16. -->
...
**Initial misdiagnosis (build 0510FC3E)** — `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md`:
...
**CORRECTED root (build 0510FC3E)** — `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md`:
...
**Current-code state (build 0510FC3E)** — `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md`:
...
`docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` — Fable ~85% root = mechanism (a):
...
`docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` — the shared reuse: each of the
...
Session summary + decisive next experiment — `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md`:
...
`docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` — a runtime A/B via
...
The intermediate `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` and
`docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` both claimed fb=0 dir_reuse
...
corrected as a MEASUREMENT ERROR** in `docs/history/docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md`:
...
`docs/history/docs/history/compiled-caw-4node-doublealloc-forceblock.md` — default flipped `mxfs_dir_force_block` 1→0
