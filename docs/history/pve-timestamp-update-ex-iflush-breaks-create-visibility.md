<!-- CORRECTED: the fio_perf-fix "dir_reuse regression" was a CONFOUNDED A/B (load asymmetry), NOT deterministic. Fixed build passes dir_reuse 11/11 under… -->
...
fio_perf O_DIRECT -EAGAIN bug (`docs/history/docs/history/pve-fio-odirect-write-eagain-after-dropcaches.md`).
...
`docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md` (it fired once on 0.11.35 too).
...
`docs/history/docs/history/pve-fio-odirect-write-eagain-after-dropcaches.md` (bug 1, verified fix),
`docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md` (the create-visibility / dead-shell /
P13-VISNUDGE flaky class this belongs to),
`docs/history/docs/history/pve-agi-buf-hold-leak-umount-wedge-not-sess76-readahead.md` (the one genuinely
