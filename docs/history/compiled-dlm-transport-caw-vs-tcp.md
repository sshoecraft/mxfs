<!-- CAW is the load-bearing primary DLM transport; TCP DLM is a <16-node fallback with straggler + phantom-lock defects. Compiled. -->
...
`docs/history/docs/history/docs/history/compiled-dlm-transport-caw-vs-tcp.md`.
...
Per `docs/history/docs/history/compiled-dlm-transport-caw-vs-tcp.md` (Session 69, 2026-03-20): under concurrent
...
See `docs/history/docs/history/compiled-dlm-transport-caw-vs-tcp.md`. Full TCP DLM transport added in `dlm/v5_mount.c`,
...
See `docs/history/session-30-lessons.md`. **Path A (manual-bio CAW submission) is the
