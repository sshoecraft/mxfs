<!-- Compiled: the P53 fossil di_next_unlinked campaign 0.11.377-394 — arms eliminated, A-prime store v1-v5, two proven roots, FIXED AND VERIFIED. -->
...
(`docs/history/docs/history/docs/history/compiled-p53-fossil-next-unlinked-campaign.md`).
...
- **Buffer-scoped gating** — the 0.11.382 non-destructive gate
  ...
  **Lesson: a defense scoped to the buffer cannot close a bug whose path crosses
  ...
  (`docs/rulings/tail8-382-gate-shipped-gpt-ruling.md`,
  `docs/history/docs/history/docs/history/compiled-p53-fossil-next-unlinked-campaign.md`).
...
preserved nothing for it (`docs/history/docs/history/docs/history/compiled-p53-fossil-next-unlinked-campaign.md`).
...
every other cycle (`docs/history/docs/history/docs/history/compiled-p53-fossil-next-unlinked-campaign.md`).
