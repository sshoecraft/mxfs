<!-- sess30(ccloop) WIN: 4/tcp = 17/17 (build 04A615EE + winning modargs). soak FIXED by P30 ops-recover (re-derive verifier from magic when b_ops==NULL).… -->
...
- 8/tcp: still blocked by dir_reuse_coherency 0/8 (AGI-CRC shutdown flaky-face + readdir=0/dir-missing face) — see `docs/history/compiled-dir-reuse-levers-default-crashconsist-soak-fixes.md`.
...
See `docs/history/compiled-dir-reuse-levers-default-crashconsist-soak-fixes.md`.
