<!-- Compiled: ccloop 72513a13 sess8-10 arc driving the tcp ladder from "tcp@8 dirent loss" to drc@32 first green — 9 proven fixes, 3 open fronts, recurri… -->
# The 32-node TCP DLM correctness campaign (ccloop 72513a13, sess8 → sess10)

Compiled from `docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`,
`docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`,
`docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`,
`docs/rulings/3fronts-32tcp.md`,
`docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`,
`docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`,
`docs/history/docs/history/docs/history/compiled-tcp32-dlm-correctness-campaign.md`.
...
6. **TCP epoch-consume adopt** (0.11.35, `xfs_mxfs_dlm.c` ~17172). Dropped the
   ...
   in-code as lost ~80% of the time. the instrument-first loop basis: a 61s drc@32 repro where
...
the instrument-first loop split isolated the round-open transient as the whole term: wave1 (64
...
## GPT ruling (the design-consult rule) — the governing design theme
