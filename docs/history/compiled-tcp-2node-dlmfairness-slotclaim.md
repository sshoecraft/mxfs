<!-- 2-node TCP DLM dlm_fairness: non-CAW slot-claim fix gives unique AGs (A3E2842C); residual = rare stale-readdir self-heal. -->
...
### PROVEN ROOT of the dlm_fairness FS-shutdown wedge `docs/history/docs/history/docs/history/compiled-tcp-2node-dlmfairness-slotclaim.md`
...
### FIX `docs/history/docs/history/docs/history/compiled-tcp-2node-dlmfairness-slotclaim.md`
...
### Degradation characterization (pre-fix, build F22321) `docs/history/docs/history/docs/history/compiled-tcp-2node-dlmfairness-slotclaim.md`
...
### Residual after the fix — rare self-healing stale-readdir `docs/history/docs/history/docs/history/compiled-tcp-2node-dlmfairness-slotclaim.md` `docs/history/docs/history/docs/history/compiled-tcp-2node-dlmfairness-slotclaim.md`
