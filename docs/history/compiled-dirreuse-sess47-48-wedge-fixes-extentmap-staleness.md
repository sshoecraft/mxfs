<!-- sess47-48 dir_reuse_coherency: 8-node wedge fixes + tenure-evict DABUF-hole heal; 1/2/4 tcp PASS, 8/tcp residual = reader dir extent-map staleness. -->
...
See `docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md` and
`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`.
...
**DABUF_MAP_HOLE tear = sess20 stale-LEAF** (PROVEN, `docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`):
...
`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`: da-node references leafn 8388609 not
...
This is the correctness fix for the leaf tear. Caveats (`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`):
...
the hole but is a the derived-budget rule slowness wedge (per-op leaf re-read holds dir VFS `i_rwsem` → openers block >18s
→ timeout). Not viable.
...
**GPT-5.5 consult** (`docs/rulings/leaf-coherence-invariant-and-design.md`) — invariant: at the
...
See `docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`,
`docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`, `docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`,
`docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`.
...
P13 multi-loss AND all shutdowns at 8/tcp, and holds 1/2/4 at 100%. the derived-budget rule caveat: `owner_scan` does a
...
**RULED OUT this session (all instrumented, the instrument-first loop)**:
...
marginally but intermittently and adds the derived-budget rule slowness.
...
**force_coherent REFUTES stale-cache-serve** (`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`):
...
**Writer-vs-reader split RESOLVED → READER-side** (`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`,
`docs/history/docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`): decisive run FD6E4882
...
**Secondary residual lead** (P15-REL-ABORT, `docs/history/docs/history/compiled-dirreuse-sess47-48-wedge-fixes-extentmap-staleness.md`): the
...
`inode_mht_ms=0` to see if the batch/abort interplay is root (the derived-budget rule: mht=0 very slow).
