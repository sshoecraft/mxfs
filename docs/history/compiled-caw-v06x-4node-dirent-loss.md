<!-- Compiled v0.6.4/v0.6.5 CAW 4-node dirent-loss fix chain: phantom cached-EX, grant_seq prebump, epoch-consume, acq_epoch, block-for-life → 17/17. -->
...
## Root cause 1 — phantom cached EX / dual-writer (sess2, `docs/history/docs/history/docs/history/compiled-caw-v06x-4node-dirent-loss.md`)
...
## Root cause 2 — grant_seq not bumped before bit-add CAS (sess4 FIX A, build 3AAFAEEF, `docs/history/docs/history/docs/history/compiled-caw-v06x-4node-dirent-loss.md`)
...
## Root cause 3 — CAW acquire consumed no freshness signal (sess4 FIX B, build BD8746D8, `docs/history/docs/history/docs/history/compiled-caw-v06x-4node-dirent-loss.md`)
...
Deep forensics (`docs/history/docs/history/compiled-caw-v06x-4node-dirent-loss.md`, run 003620Z) proved the residual family
...
(CD7D3E62, `docs/history/docs/history/compiled-caw-v06x-4node-dirent-loss.md`):** new `ip->i_dlm_dir_acq_epoch` (xfs_inode.h, after
...
## Root cause 5 — full closure to 17/17 (sess5, build 656E89B4, `docs/history/docs/history/caw-v065-fix-chain-4caw-17of17.md`)
