<!-- sess45 DEFINITIVE: the 2/tcp wedge = file DATA extent double-allocated over a LIVE inode chunk; data write (iomap/folio, bypasses all xfs_buf verifie… -->
...
### NEXT (the instrument-first loop): catch the data-extent allocation that overlaps a live inode chunk. Probe idea: at
...
`docs/history/docs/history/compiled-sess44-45-data-over-inode-cluster-double-alloc-wedge.md` `docs/history/docs/history/docs/history/compiled-sess44-45-data-over-inode-cluster-double-alloc-wedge.md`</body>
