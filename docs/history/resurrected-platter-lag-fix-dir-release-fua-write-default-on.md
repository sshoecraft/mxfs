<!-- sess45 (ccloop 4cb2d0a2): RESURRECTED the dropped platter-lag fix. dir_release_fua_write DEFAULTED ON (build 1DD4B2F3). Root=FUA-platter-lag (LIO wri… -->
...
(memories `docs/history/docs/history/compiled-dirreuse-sess44-46-epoch-unreliable-platterlag-isolation.md`,
