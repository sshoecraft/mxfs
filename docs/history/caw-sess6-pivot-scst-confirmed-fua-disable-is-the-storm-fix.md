<!-- sess6 PIVOT+@4 PROVEN: CAW target=SCST_FIO; fua_disable=1 @4 = 17/17 (incl dir_reuse 4/4, the cell that broke every reload-skip fix). Coherent+correc… -->
...
(different mechanism entirely). See `docs/history/docs/history/docs/history/compiled-caw-criteria-ladder-era.md` (refuted).
...
See `docs/history/docs/history/docs/history/compiled-caw-criteria-ladder-era.md` `docs/history/docs/history/compiled-fua-read-coherency-staleness.md`.
</body>
