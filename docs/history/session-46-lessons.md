<!-- sess46 (2026-06-02) — bnobt cross-node-free clobber localized to ACQUIRER stale-pristine AG buffer + frozen meta_gen; ruled out durability/medium/FUA; root = CAW concurrent-EX (claim-race or CAS). cache_coherency fails via shared-dir barrier hang. -->
