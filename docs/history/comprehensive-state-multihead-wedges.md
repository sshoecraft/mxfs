<!-- sess5 COMPREHENSIVE: dir_reuse@32/caw has 3+ NON-DETERMINISTIC wedges (bmbt-bwrite-lost-wakeup / acquire-starvation / hard-hang-spinlock). Probe buil… -->
...
## NEXT (the instrument-first loop)
