<!-- sess15 tally (build 3AD15DA9 = FIX-H3+P15I): 14/15 clean since H3. One 2/tcp crash_consistency face (inobt CRC read-fail, disk later valid) — P15I ar… -->
# sess15 running tally + the crash_consistency face

## Builds
- FIX-H3 = 3C674F70 (see docs/history/docs/history/docs/history/compiled-tcp-ladder-sess15-16-crashcc-sweep.md).
