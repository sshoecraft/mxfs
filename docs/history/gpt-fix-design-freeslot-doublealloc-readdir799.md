<!-- sess22(ccloop) GPT-5.5 fix design for dir_reuse readdir799 (free-slot double-alloc): (L3) before xfs_dir2_data_use_free verify freshly-read data_best… -->
