<!-- sess5(run6614): undestaged dir-block cold-read salvage fixes cache_coherency (2/tcp 17/17); dir_reuse blocked by master dir_epoch=0 disabling gates. -->
...
- **C7C10753** (probes-only) — deterministic fb1 2/tcp cache_coherency repro; captured full probe timeline. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
- **F8444712** — undestaged cold-read salvage in `xfs_da_btree.c`; cache_coherency 2/tcp @ fb1 PASS 2/2 (was deterministic 0/2). THE breakthrough. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
- **59784327** — salvage + soak dump_stack gate; full `./run.sh 2 tcp` = 17/17 at default fb1. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
- **3EF92062** — added owned_ex-INDEPENDENT standalone salvage for the SHUTDOWN face (2/tcp still 17/17, 4/tcp 13/17). `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
- **E101D113** — live 4/tcp dir_reuse failure probes; proved master dir_epoch=0 root. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
- **AAA382D5** — GPT-5.5 design: relepoch-based stale-base evict (TESTING). `docs/history/ccloop-fix-relepoch-evict-gpt-design.md`
- **9762C6C6** — FINAL: query-max dir_epoch + kept salvage/deferred-stale/soak-gate. 2/tcp 17/17 verified 3×. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
never zeroed). `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
block before the read (probe `P5-UNDEST-SALVAGE-EX`). `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
at BOTH fb settings). `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
FAIL. Pure diagnostic noise; soak now PASSES. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
- Fix A keep-guard tweak + `P-DBLALLOC-AGF` FUA-compare probe: harmless. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
highest-mode mirror = often stale/0. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
superseded → 100/400 dirents clobbered. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
must die at ACQUIRE (reload) or WRITE-completion, not read. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`

---

### GPT-5.5 docs/project-history.md (RULE-5 consult, for next session)
...
re-adoption. `docs/history/ccloop-fix-relepoch-evict-gpt-design.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
- **8/tcp**: unrun.
- Fast repro: `scripts/drc_reliability.sh 4 8`. `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
...
already 0, keep-guard never runs). `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
