<!-- sess29(ccloop) CORRECTED: dir_release_invalidate+relinval_clean gets dir_reuse 8/tcp to ~85% (6/7), NOT 100% (4/4 was a lucky streak; residual 799 TO… -->
...
Tools: tests/tcp/drc_passrate2.sh N "MODARGS" (dir_reuse reliability), tests/tcp/full8.sh N "MODARGS" (full suite). See `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md` `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md` `docs/history/compiled-dir-reuse-writeside-3way-merge-release-invalidate.md`.
