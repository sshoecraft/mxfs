<!-- 32/caw dlm_scaling FAIL root PROVEN: every node re-reads a shared ~400-block AG-0 region ~100+ times/op at load (0 solo) → iSCSI target read-command… -->
...
### FIX MANDATE (the derived-budget rule: can't widen floor)
...
See `docs/history/docs/history/docs/history/compiled-caw-16node-dlm-scaling-fua-storm.md` `docs/history/docs/history/docs/history/compiled-caw-16node-suite-stability.md`.
</body>
