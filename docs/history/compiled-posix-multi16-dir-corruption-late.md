<!-- sess77-80 posix_multi16 dir corruption: durable sf→block format/content tear, dir-bmap HOLE, iget sched-while-atomic FIX (305641B7), 2-node repro. -->
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-late.md` proved on a freshly-rebooted clean
16-node cluster:
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-late.md`: standalone concurrent mkdir-race + distinct-add
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-late.md`: `run_tests.sh --nodes 2 --phase
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-late.md` — VERIFIED FIX, KEEP:
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-late.md` — after fix B, posix_multi16 still
...
### Decisive NEXT (the instrument-first loop, carried into sess81+)
