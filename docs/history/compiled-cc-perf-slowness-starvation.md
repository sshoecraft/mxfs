<!-- Compiled: MXFS perf-as-coherency-failure — rsync IOPS ceiling, lazy AG-drain/yield-quantum, log starvation, CAW writer starvation, force_peer_flush. -->
...
than XFS (`docs/history/docs/history/compiled-cc-perf-slowness-starvation.md`, `docs/history/docs/history/docs/history/compiled-cc-perf-slowness-starvation.md`),
and (b) **CAW lock writer starvation** producing ~60-120s `cache_coherency` barrier stalls
(`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`, `docs/history/docs/history/compiled-agi-unlinked-list-corruption.md`).

## The rsync bottleneck is IOPS, not FUA (`docs/history/docs/history/compiled-cc-perf-slowness-starvation.md`, sess71, 2026-03-21)
...
## v6a cache architecture: FUA-read amortization + lazy AG-drain (`docs/history/docs/history/docs/history/compiled-cc-perf-slowness-starvation.md`, sess31, 2026-05-07)
...
## cache_coherency barrier stalls: eviction slowness + drevalidate deadlock (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`, sess49, 2026-06-02)
...
instrument-per-the instrument-first loop questions; NOT per-op FUA (sess43 too slow).

## Barrier stall ROOT-CAUSED = CAW writer starvation (`docs/history/docs/history/compiled-agi-unlinked-list-corruption.md`, sess50, 2026-06-03)
...
Evidence (the instrument-first loop, quantitative): new `tests/repro_barrier_latency.sh` mimics the cluster.sh
