<!-- Compiled: D-FOREIGN-REPLAY-UNGATED-IMAGES end-to-end — both defect arms, P223/adopted containment, GPT token spec, steps 1-3a shipped, 3b resume poin… -->
...
node-independent (`docs/rulings/a-d-foreign-replay-stop-ship.md`).
...
(`docs/history/docs/history/docs/history/compiled-foreign-replay-authority-tokens.md`).
...
Full spec in `docs/rulings/foreign-replay-token-design.md`.
...
cross-node (`docs/history/docs/history/docs/history/compiled-foreign-replay-authority-tokens.md`).
...
(~2030-2145) (`docs/history/docs/history/docs/history/compiled-foreign-replay-authority-tokens.md`):
...
Campaign entry and the containment code map: `docs/history/docs/history/docs/history/compiled-foreign-replay-authority-tokens.md`.
