<!-- Compiled sess51-58: multi16 shared-dir shutdown faces — stale extent/di_size, block/leaf self-skip lost-update, AGI stale-head. -->
...
- `tests/repro_agi_unlink_storm.sh 16 [ROUNDS]` — 16 nodes create + rm-rf
  ...
  `docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`.
- `tests/criteria/zero_silent_loss.sh --iters 1 --dpn 100 --mode 1` (~90s
  ...
  K/node), rarely fire — use the single-iter storm. `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
test_rename_vis_dbg (stalled >200s). `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
- ROOT 2 (deep, UNFIXED here): inode-chunk-free → block-reuse DOUBLE-ALLOC. rm-rf
  ...
  branch). `docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
- Added P54-DIRBLK-PROBE (xfs_da_btree.c ~3260): on retry-exhausted dir-block
  ...
  cache-torn vs durable vs extent-map-aliasing. `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
`docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md` — **NOTE: this root was refuted
in sess58 (below).**
...
dmesg-`-C`-all-nodes lesson above. `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
**PROVEN root + FIX** `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`
...
**FIX 6657565C is INSUFFICIENT** `docs/history/docs/history/docs/history/compiled-posix-multi16-dir-corruption-early.md`:
