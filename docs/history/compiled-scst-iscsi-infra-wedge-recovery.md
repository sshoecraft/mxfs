<!-- SCST/iSCSI CAW-READ atomic wedge: root cause, no-reboot scst_unwedge recovery, stale-PR-blocks-mkfs, and storage topology. -->
...
topology (SCST iSCSI vs the later LIO/tcm_loop pivot) these all run on. the never-reboot-clyde rule governs
...
Original sess14 framing (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, 2026-06-10, build `9C2D4FA6`):
...
were shared across all nodes (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`).
...
holder (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, `docs/history/scst-caw-read-wedge-full-recovery-proven.md`).
...
Built in `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, refined `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
fully executed+proven `docs/history/scst-caw-read-wedge-full-recovery-proven.md`, re-proven after
a 5-session false "reboot-only" conclusion in `docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`.
...
**DO NOT just `del_device disk1`** (`docs/history/scst-caw-read-wedge-full-recovery-proven.md` —
...
(`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`).

---

## The upstream SCST fix — `caw-abort-reclaim` (`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`)
...
- Deploy: `cd /src/scst/scst && make && sudo make install` to
  ...
  the never-reboot-clyde rule permits it.** As of sess72/78 this fix was BUILT but **NOT yet installed/verified**.

---

## Prevention / infra hardening

- **Chunked BLKZEROOUT** (`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, v0.4.11):
...
- **Guest SCSI timeout widen:** `echo 180 > /sys/block/sda/device/timeout` per node —
  ...
  (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`).
- **Never TaskStop a cluster run mid-test** (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`):
...
- **NEVER reboot to recover** (`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`): the old
  `@reboot`-hook + `sudo reboot` protocol was followed and **hung clyde hard — user had to
  HW-reset**. This is the origin of the never-reboot-clyde rule. The `scripts/clyde_boot_recover.sh` @reboot cron
...
- **VMs fail virsh-start, iSCSI LUN dead (ENXIO)** (`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`):
...
- **QNAP iSCSI target dies under storm** (`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`):
...
**MAJOR PIVOT 2026-06-14 — LIO/tcm_loop replaces SCST iSCSI** (`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`):
...
`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`: on build `9C2D4FA6`, `zero_silent_loss`
...
- **P136 drain-rescue** (build `7BD3933D`, KEEP, `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`): fixes
  ...
  lost-update.
- **P78 torn-dinode barrier** (build `7D1492FC`, `docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`):
...
*Sources folded: `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, `docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
`docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, `docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
`docs/history/scst-caw-read-wedge-full-recovery-proven.md`, `docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`,
`docs/history/docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`, `docs/history/docs/history/compiled-scst-iscsi-infra-wedge-recovery.md`.*
