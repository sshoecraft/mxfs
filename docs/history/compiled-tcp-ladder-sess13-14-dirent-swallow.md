<!-- Compiled sess13-14 TCP ladder: dirent-swallow tenure-boundary race, fence sf-dangler leak, SF-tenure-floor, first 8/tcp 17/17. -->
...
sess13:
- **705FDC6E** — FIX-C: entry-locks-before-AG-grants in xfs_remove + xfs_rename. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md` `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **61EFACE7** — +P13-PLACE placement ledger, P64 present2 (node2_f1 tracer).
- **B008722F** — +FIX-D v1: iget visibility nudge (raw-DLM PR) — insufficient alone. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
- **E0C0D2C5** — +P13-SFRM (sf-removal ledger, watch-gated) + P56-RELOAD-MERGE prints ours_cnt/ours=[names]. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **3BB25A6E** — FIX-E: slot-level FUA patch past the P91 logged-buffer guard. `docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **3D4A350E** / **496C1710** (=3D4A350E minus dirwr-gate on P13-PLACE) — full FIX-C/D/E stack; sess13 END build. `docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`

sess14:
- **5A31CD27** — floor only (SF-TENURE-FLOOR). tds standalone 41.7s PASS 8/8. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **360111F2** — +FIX-F (iget_miss_reload li_list gate), never regression-tested alone.
- **11FAB23A** — +P14 tripwires (sf desync sentinels); iter r6. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **8E654A57** — RC: floor + FIX-F + P14 tripwires + **dir_sf_mht_ms=40 default**. First default-config 17/17. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
- **4D677327** — lineage head at sess14 handoff (+FIX-G destage-then-reload for 2/tcp). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
observed), xfs_link dir→AG edge (converges same as defer_finish). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
(sess83-88 stale-base RMW family). Faces triaged: `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
shell path, (3) inode free (mode→0) not destaged before chunk realloc. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
iters). 6 consecutive clean at checkpoint. `docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
FIX-E slot patch (ret=2) or ladder escalation. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
libxfs sf.c). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
live). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
`docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
recurs now that the hang is fixed. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md` `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
- 4/tcp = 17/17 ×1 (8E654A57); 1/tcp = 16/16 ×1. 4/tcp had earlier logged 8
  CONSECUTIVE clean 17/17 on 496C1710 (longest streak, ~35 session iters). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md` `docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
Next-session plan (the instrument-first loop): (1) instrument the boundary — on P-DIRWR of a watched dir
...
extend P15 holders-recheck). `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
consider gap≥N+2 and check P14-DESTAGE counts if tds slows. `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess13-14-dirent-swallow.md`
...
- **Forensic death-spiral**: heavy per-fail-round forensics inflate rounds and blow
  ...
  face.
- Timing is a first-class failure (the derived-budget rule): tds 66-116s vs 60s window is a FAIL even
  at 150/150 correct.
