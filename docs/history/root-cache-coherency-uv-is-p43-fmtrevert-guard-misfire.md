<!-- sess49 FIXED 90-session cache_coherency blocker + got FULL 2/tcp suite 17/17: P43-DIR-FMTREVERT guard misfired on legit peer block→shortform shrink.… -->
...
### PROVEN ROOT (the instrument-first loop, raw-disk + dmesg): 100% READ-SIDE guard misfire
...
Related: `docs/history/docs/history/compiled-sess46-48-dir-reuse-leaf-hole-uv-read-write-staleness.md` `docs/history/docs/history/compiled-sess43-44-2tcp-suite-contamination-forceblock-regression.md` `docs/history/docs/history/compiled-sess46-48-dir-reuse-leaf-hole-uv-read-write-staleness.md`
