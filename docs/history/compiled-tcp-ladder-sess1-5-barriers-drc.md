<!-- Compiled ccloop a9a03929 sess1-5: TCP 8-node dir_reuse_coherency ladder — barriers-off pace, iunlink/nest/suppression root fixes. -->
...
`docs/history/docs/history/docs/history/compiled-tcp-ladder-sess1-5-barriers-drc.md` `docs/history/docs/history/docs/history/compiled-tcp-ladder-sess1-5-barriers-drc.md`
...
`docs/history/end-road-b-barriers-off-t6-silent-eio-blocker.md`
...
`docs/history/docs/history/docs/history/compiled-tcp-ladder-sess1-5-barriers-drc.md`
...
- Storage restore after clyde reboot: `scripts/lio_tcm_setup.sh setup` + `echo '<REDACTED-ROTATED>' > /tmp/.mxfs_pass` (fileio backstore ~/disk.img → tcm_loop → /dev/mxfs-shared). run.sh preserves FAIL logs at `/tmp/run_dir_reuse_coherency_<RUNID>/`.
