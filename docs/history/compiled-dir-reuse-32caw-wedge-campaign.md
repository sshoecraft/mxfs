<!-- Compiled: dir_reuse_coherency@32/caw — the 9-session multi-wedge campaign (ccloop a864, 0.10.34-0.10.61); six distinct wedges, roots and refutations. -->
...
bmbt (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
(`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
contention. A stuck acquire (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
different slots** (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
(`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/wedge2-fresh-bmbt-inflight0-lostwakeup.md`).
...
kworkers blocked (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
the sync waiter is never woken (`docs/history/root-wedge2a-async-completion-routing.md`).
...
2. Diagnostic build adding `sync_wait / ioend_seen / relse_seen` to the probe — the
   decode table that named the answer (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
   `docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
3. **`b_mxfs_force_sync` set by sync submitters under `b_sema` BEFORE submit**, OR'd into
   ...
   `iowait_stuck=0` (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
peers starve past the 120s barrier (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
re-acquire (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/comprehensive-state-multihead-wedges.md`).
...
is the truth (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
**separate AG-DLM** (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`,
`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
...
buffer's event ring (`docs/history/docs/history/docs/history/compiled-dir-reuse-32caw-wedge-campaign.md`).
