<!-- sess26(ccloop) PROGRESS: dir_gen_per_handoff=1 (uncap the fast-path epoch gen-bump so i_dlm_dir_gen advances on EVERY handoff, not once/reload) REDUC… -->
