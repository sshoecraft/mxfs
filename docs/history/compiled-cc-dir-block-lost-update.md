<!-- Compiled sess68-100: durable write-side dir-block/shortform lost-update behind unlink/cross/rename coherency + GPT/Gemini fix designs. -->
...
single_node 104%, all robustness/tooling green per `docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`). Its four
...
- **BLOCK/LEAF dir** (dirents in separate DATA blocks): `rename_visibility` (80
  ...
  bites (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`).

## HARD on-disk proof it is write-side, not transport (`docs/history/docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
...
## Release path is NOT early-unlock (`docs/history/docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
...
### sess80 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — HB evict-ring generalized to DIR_MODIFY
...
### sess82 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — evict-ring was DEAD cross-node in CAW
...
### sess83 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — noino-BAST root for BLOCK-format dirs
...
### sess84 (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`) — shortform loss = LAST committer reverts its own dinode
...
### sess85 (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`) — cross_visibility shortform loss FIXED (provisional)
...
### sess88 (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`) — dir-block durable lost-update FIXED (noino-BAST AG drain)
...
shutdown eliminated; cwr now runs. REVERTED (the instrument-first loop disproven): adding
...
### sess95 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — inode-reload fixes, cache_coherency 1/4→3/4
...
### sess96 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — typeflip-ftype fix + FUA disproven
...
### sess96 GPT design (`docs/history/docs/history/compiled-bnobt-inode-double-alloc-ccloop.md`) — invariant set
GPT-5.5 (after 2 Gemini consults, the design-consult rule). **Inv 1**: DLM EX demote/release MUST be a
...
### sess97 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — WRITER-SIDE publish-before-notify (rename PASS)
...
### sess97 GPT design (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — durable per-dir SEQLOCK epoch
...
### sess98 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — the decisive WRITE-submission trace (P-DIRWR)
...
### sess98 GPT design (`docs/history/session-98-gpt-fix-design.md`) — buffer cache is TENURE-LOCAL
...
### sess99 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — release-side xfs_buf_stale WORKS (block-dir loss FIXED)
...
(REVERTED, the instrument-first loop 2a): acquire-side xfs_buf_stale made unlink WORSE (aggressive
...
### sess100 (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`) — cross-visibility root = WRITE-SIDE publish-before-notify (bug generalized)
...
- **NEVER whole-AG `xfs_ail_push_ag_sync`** in a handoff/release path — wedges under
  ...
  targeted `mxfs_dir_flush_data_blocks` (O(dir size)). (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`,
  `docs/history/docs/history/compiled-cc-dir-block-lost-update.md`, `docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
- **Heavy drain MUST be off the BAST/CAW-poll thread** (deadlock vs log force /
  writeback / DLM rx). (`docs/history/docs/history/compiled-bnobt-inode-double-alloc-ccloop.md`)
- **fua_disable=1 is correct**; FUA reads the stale platter (SCST write-back cache),
  45x slower AND worse. Never re-enable. (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
- **Acquire-side cold-read/refresh for dirs is a DEAD END** under fua_disable=1 — every
  ...
  publishes). The fix is WRITER-side publish-before-notify. (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`,
  `docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
- **xfs_log_force(SYNC) does NOT synchronously wait for unpin** — the async
  ...
  pal/linux/xfs_buf.c:1020 → de-static). (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
- **CIL window** (`!in_ail && !pin ⇏ durable`): a just-committed change is briefly
  ...
  treated this as durable. (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`, `docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
...
- Trustworthy run needs a REAL reboot: `LIBVIRT_DEFAULT_URI=qemu:///system virsh
  ...
  JUNK. (`docs/history/docs/history/compiled-cc-dir-block-lost-update.md`)
- Remount `/mnt/mxfs-src` (192.168.120.1:/src/mxfs, holds tests/mxfs_test.sh) on ALL
  ...
  (`docs/history/docs/history/compiled-shortform-lostupdate-sess8-9-convblk-doublegrant.md`)
