<!-- sess6/run6614: gg_refresh+leaf_flush fix dir_reuse to 4/tcp 100%; 8/tcp blocked by divergent-grow torn extent-map + inode-reuse cascade. -->
...
(gg_refresh + leaf_flush, 12/12). Details: `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`, `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`.
...
- **Phantom-EX / DLM-serialization-hole (sess50/sess52)**: REFUTED on current build.
  ...
  double-grant fixes since sess52 closed it. `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`
...
- **Disk-space env (NOT an mxfs bug), masked ~5+ tests**: mxfs's heavy always-on
  ...
  have room before trusting any 8/tcp result.** `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`
...
were the disk-space masking, not independent bugs — `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md` vs `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`.)

8-node dir_reuse is genuinely flaky (~1/3: run1 PASS, run2/run3 FAIL) at 8-node
contention. Multiple fault FACES (dmesg): `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`
...
2. **Inode-reuse cascade (distinct coherence domain)**: `mxfs: DLM inode reload
   ...
   dir-block gg_refresh. `docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md`
...
- FAST repro: `scripts/drc_reliability.sh 8 6` (each 8-node run ~7–9 min; runs got
  slower with gg_refresh+leaf_flush ~4–5 min/run — watch the derived-budget rule wall-vs-budget).
...
`docs/history/docs/history/compiled-dirreuse-run6614-sess6-gg-refresh-leaf-flush-divergent-grow.md` — build 9AA569A0, deployed test1-8, 3 of 4 columns
