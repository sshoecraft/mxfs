<!-- v0.3.61-v0.3.109 baseline: SCSI READ-FUA, cached-AG divergence root cause, CAW cross-init OK, kernel CAW broken, false-positive script fix. -->
...
## sess22 — extend FUA, first false dawn (`docs/history/docs/history/compiled-early-caw-fua-baseline-v036x.md`)
...
## sess23 — the PASSes were a script bug; honest baseline (`docs/history/docs/history/docs/history/compiled-early-caw-fua-baseline-v036x.md`)
...
## sess24 — smoking gun: cached-AG divergence; LIO CAW exonerated (`docs/history/docs/history/docs/history/compiled-early-caw-fua-baseline-v036x.md`)
...
## sess25 — why the cache diverges: the single→multi transition bug (`docs/history/docs/history/compiled-early-caw-fua-baseline-v036x.md`)
...
## sess26 — two root causes; kernel SCSI CAW is broken (`docs/history/session-26-lessons.md`)
