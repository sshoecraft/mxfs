<!-- sess59-60 4-node TCP dir_reuse_coherency (16/17): crash fix + readdir gen-bump; residual = durable writer-side node1_f1 dirent lost-update. -->
...
### sess59 — first fail + three superseding diagnoses (the instrument-first loop loop)
...
Do NOT run 8-node (EXP=800, worse). See `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`.

Diagnosis progression (each superseded the last):
1. **Stale-disksize / gen-equal** `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`: P62 probe
...
2. **Grantless-NL async-evict latency** `docs/history/drc-root-grantless-readdir-async-evict-latency.md`:
   ...
   (i_dlm_dir_gen>0) only; or readers take a real PR grant (heaviest, the derived-budget rule risk).
3. **CORRECTED root — durable dirent lost-update** `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`
...
`dir_reuse_coherency`, 8/tcp never run. See `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`.
...
and data block = orphaned inode. See `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`.
...
**dataclobber=2 REFUTED** `docs/history/docs/history/compiled-sess59-60-4node-tcp-dir-reuse-readdir-miss-writer-clobber.md`: `MXFS_EXTRA_MODARGS='dataclobber=2'`
...
### Perf (parallel the derived-budget rule concern)
