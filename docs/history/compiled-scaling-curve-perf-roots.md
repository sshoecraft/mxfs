<!-- Compiled roots of scaling_curve + single_node_paired perf: BAST publish-bomb, scoped publish+floor-gate, reload guard, missing mkfs. -->
...
## sess18 — scaling_curve timeouts were infra, not FS (`docs/history/docs/history/docs/history/compiled-scaling-curve-perf-roots.md`)
...
## sess21 — single_node_paired 180% → PASS 102%, + reload-guard corruption fix (`docs/history/docs/history/docs/history/compiled-scaling-curve-perf-roots.md`)
...
**single_node_paired 180% → PASS 102%**, three measured the instrument-first loop roots:
...
## sess28 — scaling_curve dual root cause: LUN saturation + BAST publish bomb (`docs/history/docs/history/docs/history/compiled-scaling-curve-perf-roots.md`)
...
## sess29 — scoped publish landed + honest gate correction → PASS (`docs/history/docs/history/docs/history/compiled-scaling-curve-perf-roots.md`)
...
**Criterion correction (scaling_curve.sh), both PROVEN per the instrument-first loop:**
