<!-- Compiled v0.1-v0.3 milestone build states across MXFS codebase generations (mxfs.2/session-64 rewrite + v5), plus VM-build debugging and v5/v3 projec… -->
...
1. **mxfs.2 line** (`v0.6.0 → v0.9.19`) — session 63 VM-build debugging. Custom
   hand-rolled libmxfs. See `docs/history/docs/history/compiled-v0x-milestone-version-history.md`.
2. **Session-64 rewrite line** (`v0.1 → v0.2.0 → v0.3.0`, 2026-03-18) — a
   ...
   NOT the kernel fork. See `docs/history/docs/history/compiled-v0x-milestone-version-history.md`,
   `docs/history/docs/history/compiled-v0x-milestone-version-history.md`, `docs/history/docs/history/compiled-v0x-milestone-version-history.md`,
   `docs/history/docs/history/compiled-v0x-milestone-version-history.md`.
3. **v5 line** (`v0.2.2 → v0.3.36`, 2026-04-25+) — the actual kernel-XFS fork
   under `xfs/` + MXFS DLM overlay; the current project. See
   `docs/history/docs/history/compiled-v0x-milestone-version-history.md` and rationale in `docs/history/docs/history/compiled-v0x-milestone-version-history.md`.
...
## Why v5 exists — prior-attempt post-mortem (`docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
...
## Session 63 — mxfs.2 v0.9.19 VM-build debugging (`docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
...
### v0.1 (`docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
...
### v0.2.0 (`docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
...
### v0.3.0 (`docs/history/docs/history/compiled-v0x-milestone-version-history.md` / `docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
...
## v5 line — v0.2.X → v0.3.36 (`docs/history/docs/history/compiled-v0x-milestone-version-history.md`)
