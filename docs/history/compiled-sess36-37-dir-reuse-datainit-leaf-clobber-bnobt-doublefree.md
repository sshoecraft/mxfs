<!-- Compiled sess34-37: dir_reuse 2/tcp correctness — datainit-clobber refuted benign, real root = stale block0/leaf RMW + bnobt double-FREE from stale b… -->
...
**sess34** (`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`, build 327ED8B2): PROVED release
...
**sess36 — the P31E "datainit" false root** (`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md` build
4D56CB92; `docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md` build BC6D7A5E). Believed PROVEN at the
...
(`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`, builds 4734B03F→92F442C7). Added
...
### What sess37 PROVED and what it REFUTED (instrument step 2a — do NOT re-chase)
REFUTED:
...
- **The shutdown is a stale-bmap double-FREE, NOT a double-ALLOC**
  (`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`, baseline A695EC5C). P15-INSTR at
...
- **B5 inactivation TOCTOU fix** (`mxfs_b5_nolock`, xfs_inode.c ~2960) — dropped the
  ...
  - **B5 is INERT for dir_reuse**: `INACT-SKIP-STALE=0` across 5 runs (the EX acquire for the
    ...
    (`docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`, `docs/history/docs/history/compiled-sess36-37-dir-reuse-datainit-leaf-clobber-bnobt-doublefree.md`.)
