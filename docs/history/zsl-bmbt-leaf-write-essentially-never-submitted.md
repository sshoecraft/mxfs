<!-- sess60 KEY: P60-BMBTWRITE probe shows ino=131 bmbt-leaf WRITES essentially never reach xfs_buf_submit_bio → leaf flush is MISSING, not a stale clobbe… -->
...
`docs/history/docs/history/docs/history/compiled-zsl-bmbt-leaf-dinode-torn-write.md`.
...
### NEXT (the instrument-first loop) for next session
