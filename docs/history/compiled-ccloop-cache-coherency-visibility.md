<!-- Compiled ccloop cache_coherency thread: reused-inode stale cache, durable-before-visible, mkdir-race, shortform lost-update, xfsaild deadlocks → 4/4… -->
...
**End state: 4/4 PASS at build `CA701441` (sess `docs/history/docs/history/compiled-concurrent-shared-dir-barrier-lostupdate.md`).**
...
- `6B8A19F5` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: shortform-PARENT new-child invisibility FIXED. Proactive
...
- `5E2660AC` — `docs/history/docs/history/compiled-concurrent-shared-dir-barrier-lostupdate.md`: drain-wedge TRUE ROOT = **xfsaild NULL-deref oops** in
...
- `1853FF8F` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: drain-wedge (the OTHER half) = create-path flush **leaks
...
- `9F289917` (VERIFIED 2/4) → `92CE435D` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: **xfsaild
...
- `7BBF740C` → `C3B5DFE4` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: **cross_write_read `.md5` sidecar
...
- `86420BFE` (3/4) — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: two KEEP fixes. (a) **bast NULL-deref unmount crash** — pending
...
- `DF34891E` (untested) — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: sess117 AG-meta hard-barrier **REFUTED** (evicting all
...
- `C69013B3` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: **iflush→DLM-EX discriminator (KEEP, corruption gone)** —
...
- `E9963FFA` — `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: bnobt SHUTDOWN fixed (P122 write-side interlock,
...
- `1F7AF33C` / `C01185FA` (2/4, REGRESSED from sess23's 3/4) — `docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`
  + `docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: on a CLEAN cluster cross_visibility +
...
- `1371EA35` (still RED) — `docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: shortform parent
...
- `104BEBA0` (untested, RED) — `docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: TRUE ROOT =
...
- `1C7F8320` — `docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`: **unlink_visibility TRUE
...
- `CA701441` — `docs/history/docs/history/compiled-concurrent-shared-dir-barrier-lostupdate.md`: **cache_coherency 4/4 PASS.** Last
...
- Block-format dir-data lost-update as the unlink_visibility root (`docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`, corrected
  sess120); the "disk has 120" observation was a create-only+sleep2 variant masking the race.
- sess113 merge_dirs/FUA drain-wedge theory (`docs/history/docs/history/compiled-concurrent-shared-dir-barrier-lostupdate.md`).
- sess117 AG-meta hard-barrier / evict-all-AG-meta-on-release (`docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md` — reintroduced bnobt
  double-free).
- Shortform parent (ino 131) as the unlink root (`docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`
...
- "Loser's cached parent dir is stale" / PR-storm starvation as the unlink root
  (`docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md` refuted both).
- P110 read-side interlock premise "in-core is always authoritative"
  (`docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md` — same premise sess23 disproved write-side).
- CAS-storm framing of the 100-retry exhaustion (`docs/history/docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md` —
...
- di_gen / di_size / disk_mode==0 as standalone coherency discriminators — all false-positive on
  new-inode first flush; use DLM lock-lineage/epoch/first-flush-flag instead (`docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`,
  `docs/history/docs/history/compiled-ccloop-cache-coherency-visibility.md`).
...
- **Slowness IS failure.** Healthy cache_coherency runs in ~20–60s; a 200s+ run means a node is still
  ...
  it pass (the derived-budget rule / [[feedback_timing_is_first_class]]).
