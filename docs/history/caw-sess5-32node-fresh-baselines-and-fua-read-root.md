<!-- sess5: FRESH-substrate 32/caw baselines (dlm_scaling=28/32, cache_coherency=0/32 timeout) prove the read-storm is FUNDAMENTAL not degradation. Storm… -->
...
See `docs/history/caw-32node-dlm-scaling-root-shared-ag0-reread.md` `docs/history/docs/history/docs/history/compiled-caw-criteria-ladder-era.md`.
