<!-- Compiled sess20-37/38: Mode A peer-coherency arc — dir3-buf drain, adaptive quantum, disklock AIL drain, single-node log wedge, build hashes. -->
...
Sources: `docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`,
`docs/history/session-37-lessons.md`.
...
- The `magic=0x0` "disk reads zeros / LIO durability cliff" signal that drove
  ALL of `docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md` and
  `docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`
...
the instrument-first loop (hypothesis → instrument → prove → patch → loop) was added to CLAUDE.md
in sess34 precisely because prior sessions patched from code-reading and kept
re-surfacing the same bug (`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`).
...
= no-op). (`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`)
...
durable on LIO. (`docs/history/docs/history/docs/history/compiled-mode-a-ail-drain-early.md`)
...
Instrumented under strict the instrument-first loop (user directed: stop patching v5). Results in
...
Consumed all of sess36 (16 wrong size/AIL theories). the instrument-first loop capture:
...
barriers; rsync_paired needs `mxfs_multinode_bench.sh`). (`docs/history/session-37-lessons.md`)

---

## sess38 continuation (same memory body) — the coherency bug closed, then N-way residual

The ``docs/history/session-37-lessons.md`` body runs into sess38. Build progression and findings:
...
- **1AFD468549F9289BF3B08DF** — block-dir read-time gen-invalidation LANDED in
  ...
  dead-ends proven (the instrument-first loop, sysrq evidence): in-place `_xfs_buf_read` on the
...
- **Final residual** (build 8C04BCCC): CLEAN 4-node bisection —
  ...
  (per the user's timing rule, a transient IS a failure). (`docs/history/session-37-lessons.md`)
