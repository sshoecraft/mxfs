<!-- sess5(run6614) FIX build AAA382D5 (GPT-5.5 design, TESTING): gate dir stale-base evict on RELIABLE LOCAL i_dlm_epoch/b_mxfs_relepoch instead of the b… -->
## sess5 (run 6614) — relepoch-based stale-base evict (GPT-5.5 consult design)

Build **AAA382D5** (TESTING). Addresses `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`.
...
See `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md` `docs/history/docs/history/compiled-dirreuse-run6614-sess5-coldread-salvage-master-epoch-zero.md`
