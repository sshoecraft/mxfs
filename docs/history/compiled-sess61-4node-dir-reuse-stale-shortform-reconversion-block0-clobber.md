<!-- sess61 compiled: 4/tcp dir_reuse_coherency durable node1_f* loss = dirty stale block0 kept by drain-evict dirty-guard; grant_gen fix refuted. -->
...
1. **Fork-format face** `docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md`
...
2. **Content/data-buffer face (dominant steady face)** `docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md`:
...
3. **Buffer-level DECISIVE** `docs/history/decisive-dirty-bufgen0-divergent-block0-kept-by-dirty-guard.md`
...
### The exact code gap `docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md`
...
`docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md` laid out sess10's
...
`docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md`):
...
`docs/history/docs/history/compiled-sess61-4node-dir-reuse-stale-shortform-reconversion-block0-clobber.md` frames the fork: for an EX holder's
