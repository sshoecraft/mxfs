<!-- Compiled: live foreign-slice XFS journal replay for crash_consistency+fence_during_write; non-comparable per-node LSNs; di_changecount fix. -->
...
## sess17 — root cause + design (`docs/history/docs/history/docs/history/compiled-foreign-replay-crash-consistency.md`)
...
## sess18 — foreign replay SHIPPED, crash_consistency PASS (`docs/history/docs/history/docs/history/compiled-foreign-replay-crash-consistency.md`)
...
## sess76 — fence_during_write ROOT: foreign replay reverts peer data (`docs/history/docs/history/docs/history/compiled-foreign-replay-crash-consistency.md`)
...
## sess77 — fence_during_write FIXED → PASS (`docs/history/docs/history/docs/history/compiled-foreign-replay-crash-consistency.md`)
