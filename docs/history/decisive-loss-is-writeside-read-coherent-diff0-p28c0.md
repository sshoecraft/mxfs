<!-- sess28(ccloop) DECISIVE on a CLEAN cluster: dir_reuse 8/tcp loss is WRITE-SIDE (read fully coherent: diff1=0 over 300 samples, p28c=0, rdmiss=1). Rea… -->
