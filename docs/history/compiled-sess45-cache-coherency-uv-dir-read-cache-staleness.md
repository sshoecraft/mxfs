<!-- sess45: cache_coherency uv fail PROVEN = node1 dir-block READ cache staleness; suite at 14/17 (build EF006296). -->
...
(`docs/history/fix-partial-iwrite-skips-fresh-free-inodes-inode-alloc-buf.md`, KEEP — confirmed by
`crash_consistency` passing in-suite). See `docs/history/docs/history/compiled-sess45-cache-coherency-uv-dir-read-cache-staleness.md`.
...
See `docs/history/docs/history/docs/history/compiled-sess45-cache-coherency-uv-dir-read-cache-staleness.md`. Reliable repro: reboot
...
`docs/history/docs/history/docs/history/compiled-sess45-cache-coherency-uv-dir-read-cache-staleness.md`):
...
See `docs/history/docs/history/docs/history/compiled-sess45-cache-coherency-uv-dir-read-cache-staleness.md`. `sb->s_d_op =
...
See `docs/history/docs/history/compiled-sess45-cache-coherency-uv-dir-read-cache-staleness.md`. `mxfs_dir_force_evict` ALREADY defaults
